...
/*
In this class we will store utility methods that can be applied to any browser contents.
Anything you feel like you have a good logic you can use in the future
...
public class BrowserUtils {
    ...
    /*
    Create a utility method named: wait static method
    @param sec
    @return void
